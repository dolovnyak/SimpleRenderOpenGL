...
int	pfj_parse_scene_objects(t_raw_scene *scene, t_jnode *objs_node)
{
	...
	if (!(objects_num = get_objs_num(objs_node)))
		return (ft_log_error("OBJECTS NUM", -1));
